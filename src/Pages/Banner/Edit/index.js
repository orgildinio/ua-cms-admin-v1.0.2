...
const Add = (props) => {
  ...
  useEffect(() => {
    if (props.bannerData) {
      if (props.bannerData[cookies.language] !== undefined) {
        setForm((bf) => ({
          ...props.bannerData,
          ...props.bannerData[cookies.language],
        }));
      } else {
        Object.keys(form).forEach((key) => {
          form[key] = "";
        });
        setForm(() => ({ ...props.bannerData, name: "", details: "" }));
      }

      setBannerImg(props.bannerData.banner);
