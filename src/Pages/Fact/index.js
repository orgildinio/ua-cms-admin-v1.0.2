...
const News = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Факт | WEBR Control Panel</title>
        <meta name="description" content="Факт | WeBR control panel" />
        <meta property="og:title" content="Факт | web control panel" />
      </MetaTags>
      <PageTitle name={`Факт ( ${cookies.language} )`} />
        ...
        <div className={css.PanelControl}>
          <div className="col-md-4">
            <div className={css.PanelTabelHeader}>
              ...
              >
                <i className="fas fa-plus-circle"></i> Факт нэмэх
              </button>
              <button
                name="refresh"
                onClick={() => init()}
      ...
      <ToastContainer
        ...
        pauseOnHover
      />
      <Model modelName="Устгах" show={deleteModel} handleToggle={handleClose}>
        <div>
          <p>
            Сонгогдсон нийт: <strong> {chkBox.length} </strong> фактуудыг
...
const mapStateToProps = (state) => {
  return {
    facts: state.factReducer.facts,
    pageLast: state.factReducer.paginationLast,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    loadFact: (query) => dispatch(actions.loadFacts(query)),
    loadPagination: (pageLast) => dispatch(actions.loadPagination(pageLast)),
    deleteMultFact: (ids) => dispatch(actions.deleteMultFact(ids)),
  };
};
