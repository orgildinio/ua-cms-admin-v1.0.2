...
const FastLinks = (props) => {
  ...
  const addClick = () => {
    props.history.push("/fast-links/add");
  };
  ...
  return (
    <Section>
      <MetaTags>
        <title> Чухал холбоосууд | WEBR Control Panel</title>
        <meta
          name="description"
          content="Чухал холбоосууд | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Чухал холбоосууд | web control panel"
        />
      </MetaTags>
      <PageTitle name={`Чухал холбоосууд ( ${cookies.language} )`} />
...
const mapStateToProps = (state) => {
  return {
    ...
    pageLast: state.fastLinkReducer.paginationLast,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    loadFastLink: (query) => dispatch(actions.loadFastLink(query)),
    loadPagination: (pageLast) => dispatch(actions.loadPagination(pageLast)),
    deleteMultTopLink: (ids) => dispatch(actions.deleteMultFastLink(ids)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(FastLinks);
