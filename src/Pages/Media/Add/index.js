...
const Add = (props) => {
  ...
  const handleAdd = (values, status = null) => {
    ...
    if (!videos || videos.length < 0) delete values.videos;
    if (!audios || audios.length < 0) delete values.audios;
                  ...
                  <div className="card card-primary">
                    <div className="card-body">
                      <div className="row">
                        ...
                        <div className="col-12">
                          <Form.Item label="Хураангуй" name="shortDetails">
                            <TextArea> </TextArea>
                          </Form.Item>
                        </div>
                        <div className="col-12">
