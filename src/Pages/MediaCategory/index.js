...
import CategoryList from "../../Components/MediaCategoryList";
...
const MediaCategory = (props) => {
  ...
  return (
    <Section>
      <PageTitle name={`Медиа төрөл (${cookies.language})`} />
      ...
      <div className="row">
        <div className="col-md-8">
          <CardBoby>
            <CategoryList
              category={props.mediaCategories}
...
const mapStateToProps = (state) => {
  return {
    mediaCategories: state.mediaCategoryReducer.mediaCategories,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    saveMedia: (category) => dispatch(actions.saveMediaCategory(category)),
    deleteCategory: (catId) => dispatch(actions.deleteMediaCategory(catId)),
    updateCategory: (category) =>
      dispatch(actions.updateMediaCategory(category)),
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(MediaCategory);
