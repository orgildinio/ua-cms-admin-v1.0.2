...
const Ads = (props) => {
      ...
      render: (text, record) => {
        return (
          <div className="table-image">
            {record.banner ? (
              <img src={`${base.cdnUrl}150x150/${record.banner}`} />
            ) : (
  ...
  const handleEdit = () => {
    if (selectedRowKeys.length != 1) {
      ...
      history.push(`/web_settings/ads/edit/${selectedRowKeys[0]}`);
    }
  };
    ...
    switch (modal) {
      ...
      case "edit": {
        if (selectedRowKeys && selectedRowKeys.length === 1) {
          props.history.replace("/web_settings/ads/edit/" + selectedRowKeys[0]);
        } else {
          toastControl("error", "Нэг өгөгдөл сонгоно уу");
        }
        break;
                ...
                <div className="datatable-header-tools">
                  <div className="datatable-actions">
                    <button
                      ...
                      onClick={() => history.push(`/web_settings/ads/add`)}
                    >
